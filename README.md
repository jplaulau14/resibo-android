...
Hand it the **contents** of a post (screenshot, text body, video clip, voice memo) via the Android Share Target and it returns a **Note**: sources, reasoning trace, confidence band, and what it couldn't verify — generated by Gemma 4 running fully offline on your phone.

**The agent produces a Note, not a Verdict.** You decide.

## How to use it

Resibo is fully offline — it can only read what you hand it directly. Because of that, **share the content itself, not a link**.
